...
function criptografar(){
    ...
    var resultCripto = texto.replace(/e/g, "enter").replace(/a/g, "ai").replace(/o/g, "ober").replace(/u/g, "ufat");
...
function descriptografar(){
    ...
    var resultDescripto = texto.replace(/enter/g, "e").replace(/ai/g, "a").replace(/ober/g, "o").replace(/ufat/g, "u");
